            ...
            <div className="container mx-auto px-6 lg:flex lg:items-center lg:gap-12">
                <div className="lg:w-1/2">
                    ...
                    <p className="mt-6 text-lg leading-8 text-gray-600">
                        Olvídate del tráfico y las esperas. Con MotoTX, llegas a tu destino de forma puntual, económica y con los más altos estándares de seguridad en cada trayecto.
                    </p>
                    ...
                    <div className="mt-12 flex items-center gap-6 text-sm text-gray-500">
                        ...
                        <p>Más de <span className="font-bold text-gray-900">+500 viajeros</span> confían en nosotros diariamente</p>
                    </div>
                </div>
